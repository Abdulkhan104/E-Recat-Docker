import { Box, Button, Grid2, TextField, useForkRef } from '@mui/material'
...
const AddressFormSchema = Yup.object().shape({
  ...
  pinCode: Yup.string().required("Pin code is required").matches(/^[6-9]\d{5}$/,"Invalid Pin number!!"),
  ...
  return (
    <Box sx={{ max: "auto" }}>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Grid2 size={{xs:12}}>
          <Button fullWidth type='submit' variant='contained' sx={{py:"14"}} >
            Add Address
          </Button>
        </Grid2>
