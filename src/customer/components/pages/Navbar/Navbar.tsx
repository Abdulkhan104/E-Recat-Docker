...
import { useAppSellector } from '../../../../State/Store';
...
const Navbar = () => {
    ...
    const {auth}=useAppSellector(store=>store)
    ...
    return (
        ...
        <Box className="sticky top-0 left-0 right-0 bg-white" sx={{ zIndex: 2 }}>
                ...
                <div className="flex items-center gap-9">
                    ...
                    <ul className="flex items-center font-medium text-gray-800">
                        {mainCategory.map((item) => (
                            <li
                                // key={item.categoryId} // Added key prop here
                                onMouseLeave={() => {
                ...
                <div className="flex gap-1 lg:gap-6 items-center">
                    ...
                    {auth.user ? (
                        <Button onClick={() => navigate('/account/orders')} className="flex items-center gap-2">
                            <Avatar sx={{ width: 29, height: 29 }} src="https://r2.erweima.ai/imgcompressed/compressed_914e7cffd19953a065de76a9b3311394.webp" />
            ...
            {ShowCategorySheet && (
                <div onMouseLeave={() => setShowCategorySheet(false)} onMouseEnter={() => setShowCategorySheet(true)} className="categorySheet absolute top-[4.41rem] left-20 right-20 border">
