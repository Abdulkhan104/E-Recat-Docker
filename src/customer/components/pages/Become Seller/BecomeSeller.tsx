      ...
      <section className="hidden md:col-span-1 lg:col-span-2 md:flex justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10">
          <div className="space-y-2 font-bold text-center">
            ...
            <p className="text-lg text-primary-color">Boost Your Sell Today</p>
          </div>
          <img
            className="rounded-full border-primary-color shadow-2xl"
            src="https://www.sourcedogg.com/wp-content/uploads/2022/02/How-To-Improve-Supplier-Relationship-Management.jpg"
            alt=""
          />
        </div>
      </section>
